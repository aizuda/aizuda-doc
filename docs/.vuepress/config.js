...
module.exports = {
  ...
  title: "爱组搭 AiZuDa",
  description: '爱组搭，定位为企业级低代码开发平台,像搭积木一样进行低代码甚至零代码快速构建应用,灵活自定义可视化配置,让企业管理软件随需而变,开发效率提升多倍。',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: '低代码,低代码开发,低代码工具,低代码平台,敏捷开发平台,应用搭建工具' }],
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: '监控', link: '/pages/9xd010/', items: [
          { text: '系统监控', link: '/pages/9xd010/' }
        ]
      },
      {
        text: '低代码', link: '/pages/a10ce8/', items: [
    ...
    logo: '/img/azd.png', // 导航栏logo
    repo: 'aizuda', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: '青苗', // 必需
      href: 'https://github.com/qmdx' // 可选的
    },
    social: { // 社交图标，显示于博主信息栏和页脚栏
      ...
      icons: [
        ...
        },
        {
          ...
          title: '发邮件',
          link: 'mailto:jobob@qq.com'
        }
      ]
    },
    footer: { // 页脚信息
      createYear: 2022, // 博客创建年份
      copyrightInfo: 'AiZuDa | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
